...
srun -n 4 julia /users/$USER/Bachelor-Arbeit/src/DMRG_template_pll_Energyextrema.jl 0.5 10 1e-8 0.4 0 1 true true true > parent_calc_folder/dmrg_.out 2> parent_calc_folder/dmrg_.err
